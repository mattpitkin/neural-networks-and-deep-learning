...
class Network(object):
    ...
    def update_mini_batch(self, mini_batch, eta):
        ...
        x = np.array([xm for xm, _ in mini_batch]) # put inputs into a matrix
        y = np.array([ym for _, ym in mini_batch]) # put outputs into a matrix

        nabla_b, nabla_w = self.backprop(x, y) # matrix version
    ...
    def backprop(self, x, y):
        ...
        for b, w in zip(self.biases, self.weights):
            z = np.matmul(w, activation)+b # use matmul
            zs.append(z)
